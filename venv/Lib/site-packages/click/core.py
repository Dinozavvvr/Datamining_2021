...
class BaseCommand(object):
    ...
    parsing methods that do not depend on the Click html_parser.
    ...
    def parse_args(self, ctx, args):
        """Given a context and a list of arguments this creates the html_parser
...
class Command(BaseCommand):
    ...
    def make_parser(self, ctx):
        """Creates the underlying option html_parser for this command."""
