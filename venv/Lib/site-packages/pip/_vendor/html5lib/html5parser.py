...
class HTMLParser(object):
    ...
    def __init__(self, tree=None, strict=False, namespaceHTMLElements=True, debug=False):
        ...
        >>> html_parser = HTMLParser()                     # generates html_parser with etree builder
        >>> html_parser = HTMLParser('lxml', strict=True)  # generates html_parser with lxml builder which is strict
    ...
    def parse(self, stream, *args, **kwargs):
        ...
        >>> html_parser.parse('<html><body><p>This is a doc</p></body></html>')
        <Element u'{http://www.w3.org/1999/xhtml}html' at 0x7feac4909db0>
    ...
    def parseFragment(self, stream, *args, **kwargs):
        ...
        >>> html_parser = HTMLParser()
        >>> html_parser.parseFragment('<b>this is a fragment</b>')
        <Element u'DOCUMENT_FRAGMENT' at 0x7feac484b090>
...
def getPhases(debug):
    ...
    class Phase(with_metaclass(getMetaclass(debug, log))):
        ...
        def startTagHtml(self, token):
            ...
            # this token... If it's not, invoke self.html_parser.parseError().
    ...
    class InTablePhase(Phase):
        ...
        def clearStackToTableContext(self):
            ...
            while self.tree.openElements[-1].name not in ("table", "html"):
                # self.html_parser.parseError("unexpected-implied-end-tag-in-table",
                #  {"name":  self.tree.openElements[-1].name})
                self.tree.openElements.pop()
