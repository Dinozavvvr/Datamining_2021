...
"""
Data classes and html_parser implementations for *incremental* chart
parsers, which use dynamic programming to efficiently parse a text.
A "chart html_parser" derives parse trees for a text by iteratively adding
\"edges\" to a \"chart\".  Each "edge" represents a hypothesis about the tree
structure for a subsequence of the text.  The "chart" is a
\"blackboard\" for composing and combining these hypotheses.

A html_parser is "incremental", if it guarantees that for all i, j where i < j,
...
The main html_parser class is ``EarleyChartParser``, which is a top-down
...
class IncrementalChartParser(ChartParser):
    """
    An *incremental* chart html_parser implementing Jay Earley's
    parsing algorithm:
    ...
    def __init__(
        ...
        """
        Create a new Earley chart html_parser, that uses ``grammar`` to
        parse texts.
        ...
        :param chart_class: The class that should be used to create
            the charts used by this html_parser.
        """
