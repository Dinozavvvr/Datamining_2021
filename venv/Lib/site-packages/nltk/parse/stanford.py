...
class GenericStanfordParser(ParserI):
    ...
    _MODEL_JAR_PATTERN = r"stanford-html_parser-(\d+)(\.(\d+))+-models\.jar"
    _JAR = r"stanford-html_parser\.jar"
    _MAIN_CLASS = "edu.stanford.nlp.html_parser.lexparser.LexicalizedParser"
...
class StanfordParser(GenericStanfordParser):
    """
    >>> html_parser=StanfordParser(
    ...     model_path="edu/stanford/nlp/models/lexparser/englishPCFG.ser.gz"
    ... )

    >>> list(html_parser.raw_parse("the quick brown fox jumps over the lazy dog")) # doctest: +NORMALIZE_WHITESPACE
    [Tree('ROOT', [Tree('NP', [Tree('NP', [Tree('DT', ['the']), Tree('JJ', ['quick']), Tree('JJ', ['brown']),
    Tree('NN', ['fox'])]), Tree('NP', [Tree('NP', [Tree('NNS', ['jumps'])]), Tree('PP', [Tree('IN', ['over']),
    Tree('NP', [Tree('DT', ['the']), Tree('JJ', ['lazy']), Tree('NN', ['dog'])])])])])])]

    >>> sum([list(dep_graphs) for dep_graphs in html_parser.raw_parse_sents((
    ...
    >>> sum([list(dep_graphs) for dep_graphs in html_parser.parse_sents((
    ...     "I 'm a dog".split(),
    ...
    >>> sum([list(dep_graphs) for dep_graphs in html_parser.tagged_parse_sents((
    ...     (
    ...         ("The", "DT"),
    ...         ("quick", "JJ"),
    ...         ("brown", "JJ"),
...
class StanfordNeuralDependencyParser(GenericStanfordParser):
    ...
    def tagged_parse_sents(self, sentences, verbose=False):
        """
        Currently unimplemented because the neural dependency html_parser (and
...
def setup_module(module):
    ...
    try:
        ...
        raise SkipTest(
            "doctests from nltk.parse.stanford are skipped because one of the stanford html_parser or CoreNLP jars doesn't exist"
        )
