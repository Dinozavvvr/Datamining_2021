...
class GenericCoreNLPParser(ParserI, TokenizerI, TaggerI):
    ...
    def tokenize(self, text, properties=None):
        ...
        >>> html_parser = CoreNLPParser(url='http://localhost:9000')

        >>> text = 'Good muffins cost $3.88\\nin New York.  Please buy me\\ntwo of them.\\nThanks.'
        >>> list(html_parser.tokenize(text))
    ...
    def tag(self, sentence):
        ...
        >>> html_parser = CoreNLPParser(url='http://localhost:9000', tagtype='ner')
        >>> tokens = 'Rami Eid is studying at Stony Brook University in NY'.split()
        >>> html_parser.tag(tokens)
        [('Rami', 'PERSON'), ('Eid', 'PERSON'), ('is', 'O'), ('studying', 'O'), ('at', 'O'), ('Stony', 'ORGANIZATION'),
        ('Brook', 'ORGANIZATION'), ('University', 'ORGANIZATION'), ('in', 'O'), ('NY', 'O')]

        >>> html_parser = CoreNLPParser(url='http://localhost:9000', tagtype='pos')
...
class CoreNLPParser(GenericCoreNLPParser):
    ...
    >>> next(
    ...     html_parser.raw_parse('The quick brown fox jumps over the lazy dog.')
    ...
    >>> (parse_fox, ), (parse_wolf, ) = html_parser.raw_parse_sents(
    ...     [
    ...         'The quick brown fox jumps over the lazy dog.',
    ...
    >>> (parse_dog, ), (parse_friends, ) = html_parser.parse_sents(
    ...     [
    ...         "I 'm a dog".split(),
    ...
    >>> parse_john, parse_mary, = html_parser.parse_text(
