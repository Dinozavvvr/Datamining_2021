...
class ShiftReduceParser(ParserI):
    """
    A simple bottom-up CFG html_parser that uses two operations, "shift"
    ...
    def _match_rhs(self, rhs, rightmost_stack):
        ...
        :param rightmost_stack: The rightmost elements of the html_parser's
            stack.
        """
...
class SteppingShiftReduceParser(ShiftReduceParser):
    ...
    you to change the html_parser's grammar midway through parsing a text.
    ...
    found by the html_parser.

    :ivar _history: A list of ``(stack, remaining_text)`` pairs,
        containing all of the previous states of the html_parser.  This
    ...
    def stack(self):
        """
        :return: The html_parser's stack.
    ...
    def initialize(self, tokens):
        """
        Start parsing a given text.  This sets the html_parser's stack to
    ...
    def undo(self):
        ...
        the html_parser to successively earlier states.  If no shift or
    ...
    def reducible_productions(self):
        ...
        :return: A list of the productions for which reductions are
            available for the current html_parser state.
...
def demo():
    """
    A demonstration of the shift-reduce html_parser.
    """
