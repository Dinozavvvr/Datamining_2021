...
class ProbabilisticNonprojectiveParser(object):
    """A probabilistic non-projective dependency html_parser.
    ...
    typical parses in some languages.  This html_parser follows the MST parsing
    ...
    def __init__(self):
        """
        Creates a new non-projective html_parser.
        """
    ...
    def train(self, graphs, dependency_scorer):
        ...
        and establishes this as the html_parser's scorer.  This is used to
    ...
    def initialize_edge_scores(self, graph):
        ...
        These scores are generated via the html_parser's scorer which
...
class NonprojectiveDependencyParser(object):
    """
    A non-projective, rule-based, dependency html_parser.  This html_parser
    will return the set of all possible non-projective parses based on
    the word-to-word relations defined in the html_parser's dependency
    ...
    projective html_parser will not.
    """
    ...
    def parse(self, tokens):
        """
        Parses the input tokens with respect to the html_parser's grammar.  Parsing
