...
- Charniak, Eugene. "A maximum-entropy-inspired html_parser." Proceedings of
...
class BllipParser(ParserI):
    ...
    def __init__(
        ...
        :param parser_model: Path to html_parser model directory
        ...
        :param parser_options: optional dictionary of html_parser options, see
    ...
    def from_unified_model_dir(
        ...
        way of storing BLLIP html_parser and reranker models together on disk.
        See ``bllipparser.RerankingParser.get_unified_model_parameters()``
        for more information about unified model directories.

        :return: A ``BllipParser`` object using the html_parser and reranker
