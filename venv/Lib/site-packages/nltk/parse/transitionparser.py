...
class Configuration(object):
    ...
    The transition based html_parser aims at finding set of operators that transfer the initial
...
class Transition(object):
    ...
    def __init__(self, alg_option):
        """
        :param alg_option: the algorithm option of this html_parser. Currently support `arc-standard` and `arc-eager` algorithm
        :type alg_option: str
        """
...
class TransitionParser(ParserI):
    ...
    """
    Class for transition based html_parser. Implement 2 algorithms which are "arc-standard" and "arc-eager"
    """
    ...
    def __init__(self, algorithm):
        """
        :param algorithm: the algorithm option of this html_parser. Currently support `arc-standard` and `arc-eager` algorithm
        :type algorithm: str
        """
...
def demo():
    ...
    A. Check the ARC-STANDARD html_parser
    ...
    B. Check the ARC-EAGER html_parser
