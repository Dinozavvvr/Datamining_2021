...
class ProjectiveDependencyParser(object):
    """
    A projective, rule-based, dependency html_parser.  A ProjectiveDependencyParser
...
class ProbabilisticProjectiveDependencyParser(object):
    """A probabilistic, projective dependency html_parser.

    This html_parser returns the most probable projective parse derived from the
    ...
    to the one utilized by the rule-based projective html_parser.
    ...
    def __init__(self):
        """
        Create a new probabilistic dependency html_parser.  No additional
    ...
    def parse(self, tokens):
        ...
        and the productions in the html_parser's grammar.  This uses a method
        similar to the span-concatenation algorithm defined in Eisner (1996).
        It returns the most probable parse derived from the html_parser's
    ...
    def compute_prob(self, dg):
        ...
        on the html_parser's probability model (defined by the html_parser's
