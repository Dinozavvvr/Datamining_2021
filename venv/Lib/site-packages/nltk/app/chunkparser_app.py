...
html_parser ``nltk.chunk.RegexpChunkParser``.
"""
...
class RegexpChunkApp(object):
    ...
    HELP = [
        (
            "Help",
            "20",
            "Welcome to the regular expression chunk-html_parser grammar editor.  "
            "You can use this editor to develop and test chunk html_parser grammars "
    ...
    def show_trace(self, *e):
        ...
        for i in range(len(rules) + 1):
            ...
            # Run a partial html_parser, and extract gold & test chunks
